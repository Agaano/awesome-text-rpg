    ...
    options: [
      {
        ...
        action: {
          message:
            "Открыв левую дверь вы замечаете что вы наступили в мешок гвоздей и поранились",
          get: { damage: 5 },
        },
      },
      {
        ...
        action: {
          message:
            "Открыв среднюю дверь вы увидели тотем неизвестного божества и решили помолиться",
          get: { healing: 5 },
        },
      },
      {
        choice: "Взять обычный предмет",
        action: {
          message: "Вы взяли обычный предмет",
          get: { treasure: [getRandomItemId("basic")] },
        },
      },
      {
        choice: "Взять редкий предмет",
        action: {
          message: "Вы взяли редкий предмет",
          get: { treasure: [getRandomItemId("rare")] },
        },
      },
      {
        choice: "Взять эпический предмет",
        action: {
          message: "Вы взяли эпический предмет",
          get: { treasure: [getRandomItemId("epic")] },
        },
      },
      {
        choice: "Взять легендарный предмет",
        action: {
          message: "Вы взяли легендарный предмет",
          get: { treasure: [getRandomItemId("legendary")] },
        },
      },
