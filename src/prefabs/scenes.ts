...
const scenes: Array<SceneType> = [
	{
	  ...
	  },
	  {
		...
		type: 'scene',
		options: [
		  { choice: 'Идти к магической башне', nextScene: { id: 8, type: 'scene' } },
	  ...
	  }, 
	  {
		...
		options: [
		  ...
		  { choice: 'Продолжить восхождение', nextScene: { id: 11, type: 'scene' } },
		],
	  },
	  {
		id: 8,
	  ...
	  },
	  {
		...
		type: 'scene',
		options: [
		  { choice: 'Войти в магическую башню', nextScene: { id: 16, type: 'scene' } },
		  { choice: 'Исследовать окрестности', nextScene: { id: 17, type: 'scene' } },
		],
	  },
	  {
		id: 13,
		...
		type: 'scene',
		options: [
		  { choice: 'Исследовать новое измерение', nextScene: { id: 18, type: 'scene' } },
	  ...
	  },
	  {
		...
		type: 'scene',
		options: [
		  { choice: 'Восхождение на ледяной пик', nextScene: { id: 22, type: 'scene' } },
		  { choice: 'Поехать в таинственные пещеры', nextScene: { id: 23, type: 'scene' } },
		],
	  },
	  {
		id: 16,
	  ...
	  },
	  {
		...
		type: 'scene',
		options: [
		  { choice: 'Исследовать таинственный лес', nextScene: { id: 28, type: 'scene' } },
		  { choice: 'Вернуться в магическую башню', nextScene: { id: 29, type: 'scene' } },
		],
	  },
	  {
		id: 21,
	  ...
	  },
	  {
		...
		type: 'scene',
		options: [
		  { choice: 'Исследовать древний храм', nextScene: { id: 33, type: 'scene' } },
	  ...
	  },
	  {
		...
		options: [
		  ...
		  { choice: 'Исследовать окрестности', nextScene: { id: 42, type: 'scene' } },
		],
	  },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Использовать заклинание', nextScene: { id: 48, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Спросить богов о мудрости', nextScene: { id: 79, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Принять участие в турнире', nextScene: { id: 96, type: 'scene' } },
      { choice: 'Отказаться от предложения', nextScene: { id: 97, type: 'scene' } },
    ],
  },
  {
    id: 65,
    ...
    type: 'scene',
    options: [
      { choice: 'Исследовать новые способности', nextScene: { id: 98, type: 'scene' } },
  ...
  },
  {
    ...
    options: [
      ...
      { choice: 'Остаться в текущем мире', nextScene: { id: 101, type: 'scene' } },
    ],
  },
  {
    id: 67,
    ...
    type: 'scene',
    options: [
      { choice: 'Полностью поглотить благословение', nextScene: { id: 102, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Попросить лесных стражей о помощи', nextScene: { id: 106, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Принять предложение об обмене', nextScene: { id: 108, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Взаимодействовать с кристаллом', nextScene: { id: 112, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Экспериментировать с артефактом', nextScene: { id: 118, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Изучить древние тексты', nextScene: { id: 123, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Экспериментировать с артефактом', nextScene: { id: 127, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Принять помощь странника', nextScene: { id: 130, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Призвать забытого бога', nextScene: { id: 136, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Экспериментировать с энергией', nextScene: { id: 143, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Исследовать древнюю магию', nextScene: { id: 147, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Принять знания колдуна', nextScene: { id: 151, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Экспериментировать со свитком', nextScene: { id: 153, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Попробовать создать иллюзию', nextScene: { id: 155, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Исследовать лабораторию', nextScene: { id: 159, type: 'scene' } },
  ...
  
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Испытать силу артефакта', nextScene: { id: 161, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Принять энергию кристалла', nextScene: { id: 163, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Изучить заклинания времени', nextScene: { id: 165, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Поторговаться с таинственным торговцем', nextScene: { id: 167, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Провести магический ритуал', nextScene: { id: 169, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Прочитать пророчества', nextScene: { id: 171, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Создать магический эликсир', nextScene: { id: 179, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Попробовать использовать артефакт', nextScene: { id: 181, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Попробовать восстановиться у фонтана', nextScene: { id: 183, type: 'scene' } },
  ...
  },
  {
    ...
    type: 'scene',
    options: [
      { choice: 'Испытать заклинания управления природой', nextScene: { id: 185, type: 'scene' } },
